    ...
    <section id="prinsip" className="bg-tk-surface-container-low py-section-gap">
      <div className="mx-auto max-w-container-max px-margin-mobile md:px-margin-desktop">
        <div className="mb-16 text-center">
          <span className="font-tk-body text-tk-label-md mb-4 block uppercase tracking-widest text-tk-secondary">
            Nilai Utama Kami
          </span>
        ...
        <div className="grid h-auto grid-cols-1 gap-4 md:h-[600px] md:grid-cols-4 md:grid-rows-2">
          <div className="group relative min-h-[280px] overflow-hidden rounded-2xl bg-tk-primary-container md:col-span-2">
            <img
          ...
          <div className="group relative min-h-[240px] overflow-hidden rounded-2xl bg-tk-secondary">
            <img
              alt="Detail tangga kayu dan arsitektur hunian premium"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBzW9u6oAt14aq684ztwjAR1HnNVix5Kxj4GqFvDOiLQ5SoxAKiQ2BFg44tz53TVHd8QfrRkvk8wzqGXJJmP5S5QGEAaQ3NptdGmfsesILZyu_f28MsQNeBO_Q5L1fGSW1uQHNTfkG_wabgUeSGUd0vztnjpE5M5I0bAmAdBn6nx_tUdxnNGErtcxnKALmjtJOH6-DdlzO4IaHsYCBplHl9wxgudinQMbsDx6S1Sct66UIPQk_CI3P_F9mT5TKkNh_OqZ5thiF2Dw"
          ...
          <div className="group relative min-h-[240px] overflow-hidden rounded-2xl bg-tk-primary">
            <img
          ...
          <div className="group relative min-h-[280px] overflow-hidden rounded-2xl bg-tk-tertiary md:col-span-2">
            <img
