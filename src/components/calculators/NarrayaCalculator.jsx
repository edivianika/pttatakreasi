...
const NarrayaCalculator = () => {
  const [formData, setFormData] = useState({
    propertyPrice: 800000000, // 800 juta
    downPayment: 20, // 20%
  ...
  const handleWhatsAppClick = () => {
    const message = `Halo TKBM, saya tertarik dengan Narraya Green Residence. Berdasarkan kalkulator KPR, saya ingin konsultasi lebih lanjut tentang:
      ...
      >
        <div className="container flex h-16 items-center justify-between px-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold text-slate-800">Kalkulator Narraya</h1>
          </div>
        </div>
      </motion.header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          >
            <div className="text-center mb-6">
              ...
              />
              <h2 className="text-2xl font-bold text-emerald-700 mb-2">Narraya Green Residence</h2>
              <p className="text-slate-600">Perumahan Premium</p>
              <div className="flex items-center justify-center gap-2 mt-2 text-slate-600">
                <MapPin size={16} />
                <span className="text-sm">Jl. Noroyono Brotonegaran, Ponorogo</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-slate-600">5 langkah ke Alun-alun Ponorogo</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-emerald-600 rounded-full"></div>
                  <span className="text-sm text-slate-600">Lokasi super strategis</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-emerald-600 rounded-full"></div>
                  <span className="text-sm text-slate-600">Hunian modern tropis</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-emerald-600 rounded-full"></div>
                  <span className="text-sm text-slate-600">Fasilitas lengkap</span>
                </li>
              </ul>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="bg-emerald-50 rounded-2xl p-6 shadow-lg border border-emerald-200">
              <h3 className="text-xl font-bold text-emerald-800 mb-4">Hasil Perhitungan</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center py-2 border-b border-emerald-200">
                  ...
                  <span className="font-semibold text-emerald-600">0% (Syariah)</span>
                </div>
                
                <div className="flex justify-between items-center py-3 bg-emerald-100 rounded-lg px-3">
                  <span className="text-lg font-semibold text-emerald-800">Cicilan per Bulan:</span>
                  <span className="text-xl font-bold text-emerald-800">{formatCurrency(calculation.monthlyPayment)}</span>
                </div>
