...
const SedahCalculator = () => {
  const [formData, setFormData] = useState({
    propertyPrice: 180000000, // 180 juta
    downPayment: 15, // 15%
  ...
  const handleWhatsAppClick = () => {
    const message = `Halo TKBM, saya tertarik dengan Sedah Green Residence. Berdasarkan kalkulator KPR, saya ingin konsultasi lebih lanjut tentang:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          >
            <div className="text-center mb-6">
              ...
              />
              <h2 className="text-2xl font-bold text-green-700 mb-2">Sedah Green Residence</h2>
              <p className="text-slate-600">Cluster Islami</p>
              <div className="flex items-center justify-center gap-2 mt-2 text-slate-600">
                <MapPin size={16} />
                <span className="text-sm">Desa Sedah, Jenangan, Ponorogo</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-slate-600">Harga terjangkau berkualitas</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-600 rounded-full"></div>
                  <span className="text-sm text-slate-600">Cluster bernuansa islami</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-600 rounded-full"></div>
                  <span className="text-sm text-slate-600">Mushola terintegrasi</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-600 rounded-full"></div>
                  <span className="text-sm text-slate-600">Area bermain anak</span>
                </li>
              </ul>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="bg-green-50 rounded-2xl p-6 shadow-lg border border-green-200">
              <h3 className="text-xl font-bold text-green-800 mb-4">Hasil Perhitungan</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center py-2 border-b border-green-200">
                  ...
                  <span className="font-semibold text-green-600">0% (Syariah)</span>
                </div>
                
                <div className="flex justify-between items-center py-3 bg-green-100 rounded-lg px-3">
                  <span className="text-lg font-semibold text-green-800">Cicilan per Bulan:</span>
                  <span className="text-xl font-bold text-green-800">{formatCurrency(calculation.monthlyPayment)}</span>
                </div>
